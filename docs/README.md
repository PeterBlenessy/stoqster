...
This directory contains the technical documentation for the Stoqster project.

## Contents

- [Use Cases](use-cases.md) - Detailed application features and functionality
- [Architecture](architecture.md) - Technical architecture and design decisions
- [Development Guide](development.md) - Comprehensive development setup and guidelines
- [API Integrations](api-integrations.md) - External API documentation and usage
